...
def sign_up(josnArray):
    gdcode = getckcode();
    data = {'gdcode':'',    'regname':'test',    'regpwd':'test',    'regpwdrepeat':'test',    'regemail':'test@qq.com',    'invcode':'',    'question':'0',    'customquest':'',    'answer':'',    'regoicq':'',    'forward':'',    'step':'2',    'regsubmit':'提 交'}
    for i in josnArray:
        for j in i['key']:
            data['gdcode'] = gdcode;
            data['invcode'] = j;
